...
string006="'Faire une grille'";
string007="'Elever les KMLs'";
string008="'Lire la grille'";
string009="'Plot\nData'";
string010="'Etape (m):'";
string011="'Taille du fichier\n(points):'";
...
string037="' Les fichiers .dat sont dans le dossier:'";
string038='Pour commencer:\nCopier votre kml dans le dossier s0_import\net appuyez \"Importer un kml\" bouton';
