function [lista_pacenotes]=procesarpn(x,z,pendientes,angulos,distancias,sensibilidad,adelanto);
...
%----------------------------------------------------------------------------------------
%                                    Juntar y ordenar m�ximos y m�nimos
...
%---------------------------------------------------------------------------------------
%                       Asignar pacenotes seg�n la magnitud
